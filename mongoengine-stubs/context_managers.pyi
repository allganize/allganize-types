...
__all__ = ("switch_db", "switch_collection", "no_dereference", "no_sub_classes", "query_counter", "set_write_concern", "set_read_write_concern")
class switch_db:
...
class no_dereference:
    ...
    def __exit__(self, t, value, traceback): # -> Any:
