...
class BaseQuerySet:
    ...
    def search_text(self, text, language=...): # -> BaseQuerySet:
        """
    ...
    def count(self, with_limit_and_skip=...): # -> Literal[0]:
    ...
    def update(self, upsert=..., multi=..., write_concern=..., read_concern=..., full_result=..., **update): # -> None:
    ...
    def update_one(self, upsert=..., write_concern=..., full_result=..., **update): # -> None:
    ...
    def modify(self, upsert=..., full_response=..., remove=..., new=..., **update):
    ...
    def order_by(self, *keys): # -> BaseQuerySet:
