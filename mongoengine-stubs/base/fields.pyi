...
class BaseField:
    ...
    null: Incomplete
    sparse: Incomplete
    def __init__(self, db_field: Incomplete | None = ..., name: Incomplete | None = ..., required: bool = ..., default: Incomplete | None = ..., unique: bool = ..., unique_with: Incomplete | None = ..., primary_key: bool = ..., validation: Incomplete | None = ..., choices: Incomplete | None = ..., null: bool = ..., sparse: bool = ..., **kwargs) -> None:
        ...
