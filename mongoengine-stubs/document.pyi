...
from mongoengine.queryset import NotUniqueError as NotUniqueError
from mongoengine.queryset import OperationError as OperationError
...
class Document(BaseDocument, metaclass=TopLevelDocumentMetaclass):
    ...
    def delete(self, signal_kwargs: Incomplete | None = ..., **write_concern) -> None: ...
    ...
    @classmethod
    def ensure_index(cls, key_or_list, drop_dups: bool = ..., background: bool = ..., **kwargs): ...
    @classmethod
